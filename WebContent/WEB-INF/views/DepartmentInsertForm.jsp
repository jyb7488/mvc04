...
<div>
	...
	<div id="content">
		...
		<form action="departmentinsert.action" method="post" id="departmentInsert">
			<table>
				<tr>
					<th>부서이름</th>
					<td><input type="text" name="departmentName" placeholder="이름" id="departmentName" /></td>
				</tr>
				<tr>
