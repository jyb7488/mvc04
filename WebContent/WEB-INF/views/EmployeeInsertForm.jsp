	...
	<div id="content">
		...
		<form action="employeeinsert.action" method="post" id="employeeForm">
			<table>
				<tr>
					<th>이름</th>
					<td><input type="text" name="name" placeholder="이름" id="name" /></td>
				</tr>
				<tr>
					<th>주민번호</th>
					<td>
						<input type="text" name="ssn1" id="ssn1" style="width: 100px;" placeholder="앞 6자리"> -
				...
				<tr>
					<th>양/음력</th>
					<td>
						<input type="radio" value="0" name="lunar" id="lunar0" checked="checked"><label for="lunar0">양력</label>
						<input type="radio" value="1" name="lunar" id="lunar1"><label for="lunar1">음력</label>
					</td>
				</tr>
				<tr>
					<th>전화번호</th>
