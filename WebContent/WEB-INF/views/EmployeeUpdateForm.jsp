...
<script type="text/javascript">
	...
	$(document).ready(function()
	{
		...
		$("#submitBtn").click(function()
		{
			...
			{
				$("#err").html("최소금액 단위보다 작습니다. 다시입력하세요");
				$("#err").css("display","inline");
				return;
			}
		...
		<form action="employeeupdate.action" method="post" id="employeeForm">
			<table>
				...
				<tr>
					<th>주민번호</th>
					<td>
						<input type="text" name="ssn1" id="ssn1" style="width: 100px;" placeholder="앞 6자리" value="${employee.ssn1 }"> -
						<input type="password" name="ssn2" id="ssn2" style="width: 100px;" placeholder="뒷 7자리">
					</td>
				</tr>
				<tr>
					<th>생년월일</th>
				...
				<tr>
					<th>양/음력</th>
					<td>
						<input type="radio" value="0" name="lunar" id="lunar0" ${employee.lunar==0? "checked=\"checked\"" : ""}><label for="lunar0">양력</label>
						<input type="radio" value="1" name="lunar" id="lunar1" ${employee.lunar==1? "checked=\"checked\"" : ""}><label for="lunar1">음력</label>
					</td>
				</tr>
				<tr>
					<th>전화번호</th>
